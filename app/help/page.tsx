...
export default function Help() {
  return (
    <div className="bg-[#FCFBF8]">
      <main className="flex flex-col items-center max-w-[1200] mx-auto">
        ...
        <div className="max-w-[1200] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mb-16 gap-5 w-full">
            <LinkCard
              href="/help/general"
