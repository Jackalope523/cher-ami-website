...
const REDIRECTS: Record<string, string> = {
  ...
  '/s/spring-pc-df': '/?utm_source=postcard&utm_medium=print&utm_campaign=2026_spring&utm_content=variant_digital_fatigue',
  '/s/spring-pc-ns': '/?utm_source=postcard&utm_medium=print&utm_campaign=2026_spring&utm_content=variant_nostalgia',
};
